                                        ...
                                        <ProductDetailDesc>
                                            <div class="tab-content" id="tabs-1" aria-labelledby="ui-id-1" role="tabpanel" aria-expanded="true" aria-hidden="false">
                                                <p>
                                                    ...
                                                    <span style={{ fontSize: "15px" }}>Hệ thống kệ Drive-In pallet được thiết kế để nhập và lấy hàng chỉ từ một bên. Với hệ thống này hàng nào đưa vào sau thì sẽ lấy ra trước, theo nguyên lý “Vào sau / Ra trước” (LIFO), nếu hệ thống khoang chứa càng sâu thì việc hoạt động của xe nâng càng khó khăn. Tuy nhiên các ray dẫn được Cơ Khí TH Việt Nam thiết kế chính xác với kích thước xe nâng hàng, làm giảm khả năng xảy ra sự cố.</span></p><p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <span style={{ fontSize: "15px" }}>- Thiết kế của Cơ Khí TH Việt Nam với cấu trúc khỏe mạnh, vững trãi, tiết kiệm vật liệu, đạt các tiêu chuẩn tốt nhất về tải trọng và độ an toàn.</span>
                                                    </li>
                                                    <li>
                                                        <span style={{ fontSize: "15px" }}>- Thi công lắp đặt một cách dễ dàng, nhanh chóng.</span>
                                                    </li>
                                                    <li>
                                                        <span style={{ fontSize: "15px" }}>- Những bộ phận cấu thành hệ thống kệ Drive-In/ Drive-Thru của Cơ Khí TH Việt Nam được tiêu chuẩn hóa cho nên việc lắp đặt rất nhanh chóng và dễ dàng.</span>
                                                    </li>
                                                    <li>
                                                ...
                                                <p><span style={{ fontSize: "15px" }}>Kệ công nghiệp Cơ Khí TH Việt Nam được sản xuất từ sắt thép tiêu chuẩn JIS G3101 SS400</span><span style={{ fontSize: "15px" }}> với khả năng chịu lực và độ bền cực cao. Dây chuyển sản xuất khép kín, hiện đại với tiêu chuẩn quốc tế, công nghệ phun sơn tĩnh điện giúp sản phẩm có tuổi thọ dài lâu, chống cháy nổ, rỉ sét. </span></p>
                                                <p><span style={{ fontSize: "15px" }}>Đến với Cơ Khí TH Việt Nam, khách hàng sẽ nhận được tư vấn miễn phí về các vấn đề setup, lựa chọn kệ cho kho hàng. Cơ Khí TH Việt Nam hỗ trợ khách hàng lắp đặt và vận chuyển trên toàn quốc. Với chế độ bảo hành lên tới 3 năm, quý khách hàng hoàn toàn yên tâm về quá trình sử dụng. Đội ngũ kỹ thuật của Cơ Khí TH Việt Nam luôn sẵn sàng hỗ trợ khách hàng trong trường hợp cần thiết. </span></p>
